...
build_cpp_framework(){
	...
	# fix PHP 模版 bug
	sed -i "s/enum('tars_cpp','not_tars','tars_java', 'tars_nodejs')/enum('tars_cpp','not_tars','tars_java', 'tars_nodejs', 'tars_php', 'tars_go')/g" /root/sql/db_tars.sql
